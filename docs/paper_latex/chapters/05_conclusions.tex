...
The developed Super Ensemble Hybrid Model, utilizing a Meta-Learner with Hard Switching, represents a robust solution for crop yield forecasting. It successfully integrates process-based simulation (WOFOST 7.2) with robust machine learning (XGBoost/Huber).
