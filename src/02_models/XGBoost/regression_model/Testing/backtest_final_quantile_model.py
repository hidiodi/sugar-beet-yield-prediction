...
# --- Configuration for the Final Champion Model ---
...
def run_backtest(df: pd.DataFrame, feature_cols: list, model_lower_clone: XGBRegressor,
                 model_median_clone: XGBRegressor, model_upper_clone: XGBRegressor):
    """Performs a rolling forecast for the three quantile models."""
    print(f"\n--- Starting Backtest from {BACKTEST_START_YEAR} to {BACKTEST_END_YEAR} ---")
    all_predictions = []
...
def main():
    """Main function to orchestrate the Final Quantile Champion model evaluation."""
