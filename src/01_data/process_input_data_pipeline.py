...
def main():
    """
    Runs the data processing pipeline using configuration from src.config.
    """
    run_pipeline(
        pipeline_name=data_config.PROCESS_PIPELINE_NAME,
        script_paths=data_config.PROCESS_SCRIPTS_TO_RUN
    )
