...
OUTPUT_DIR = Path("data/01_raw/ECMWF51_monthly_germany")
...
def download_yearly_data():
    ...
    """
    logging.info("--- Starting ECMWF51 Monthly Hindcast/Forecast Download ---")
    ...
    for year in all_years:
        output_filename = OUTPUT_DIR / f"ECMWF51_monthly_germany_{year}_march_start.nc"
    ...
    logging.info("\n--- All available yearly ECMWF51 data has been checked/downloaded. ---")
